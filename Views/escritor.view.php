...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Tus Artículos</b></span></h1>
		</div>
	</div>
	<div class="text-center section lb" style="padding-top: 20px; padding-bottom: 20px">
		<a href="crear.php" class="btn btn-primary">Crear un Nuevo Artículo</a>
	</div>
