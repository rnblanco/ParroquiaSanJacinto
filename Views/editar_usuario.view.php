						...
						<div class="comment-form-main">
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">
									...
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Tipo:    <?php echo $tipo ?></h2><select class="custom-select" name="Tipo"><option value="<?php echo $tipo?>"><?php echo $tipo?></option><option value="<?php echo $tipo2?>"><?php echo $tipo2?></option></select>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
									...
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Editar" class="btn btn-warning" style="margin-right:30px"><span>Editar Usuario</span></button>
