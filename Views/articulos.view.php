        ...
        <div class="container">
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">Un espacio donde puedes ver las ultimas publicaciones sobre diversos temas que se tratan por todo el mundo en la actualidad.</p>
                </div>
            </div><!-- end title -->			
			<?php print_r($noticiasHTML)?>
        </div><!-- end container -->
    </div><!-- end section -->
