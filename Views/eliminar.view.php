...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Eliminación de Artículos</b></span></h1>
		</div>
	</div>
						...
						<div class="comment-form-main">
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">
									...
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Título:</h2><input class="form-control" name="Titulo" placeholder="Titulo" type="text" value="<?php echo $articulo['Titulo']?>" disabled>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Texto:</h2><textarea class="form-control" name="Texto" placeholder="Texto" disabled><?php echo $articulo['Texto']?></textarea>
										</div>
									</div>						
									<div class="col-md-12" style="padding-top: 10px;">
										...
										<div class="input-group mb-3">											
											...
											<div class="custom-file">
												<input id="Imagen" type="file" class="custom-file-input" name="Imagen" aria-describedby="inputGroupFileAddon01" accept="image/*" disabled>
												<label class="custom-file-label" id="imgname" for="Imagen">-</label>
											</div>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
									...
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Estado:    <?php print_r($estado) ?></h2><select class="custom-select" name="Estado" disabled><option value="<?php echo $estado?>"><?php echo $estado?></option><option value="<?php echo $estado2?>"><?php echo $estado2?></option></select>
										</div>
									</div>
