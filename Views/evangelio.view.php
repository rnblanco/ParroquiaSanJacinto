...
<body class="host_version">
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="evangelio.php">Evangelio del Día</a></li>
    ...
    <div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/evangelioimage.jpg'); background-size:cover"></div>
        ...
        <div id="testimonials" class="container parallax section db parallax-off" style="background-image:url(Imagenes/Evangelio.jpg)">
            <div class="section-title row text-center">
                <div class="col-md-8 pl-5 pr-5 offset-md-2">
					...
					<br>
					<a href="index.php" class="hover-btn-new orange"><span>Volver a la sección Inicio</span></a>
                </div>
            </div><!-- end title -->                    
        </div><!-- end container -->
    </div><!-- end section -->
