...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Creación de Artículos</b></span></h1>
		</div>
	</div>
							...
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">									
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Título:</h2><input class="form-control" name="Titulo" placeholder="Titulo" type="text">
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Texto:</h2><textarea class="form-control" name="Texto" placeholder="Texto"></textarea>
										</div>
									</div>						
									<div class="col-md-12" style="padding-top: 10px;">
										<h2>Imagen:</h2>
										<div class="col-lg-4 col-md-6 col-12 blog-item image-blog img-center" style="margin-bottom: 50px;">
											<img id="ImgA" src="" class="img-fluid" style="height: 140px; width: 330px">
										</div>
									...
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Crear" class="btn btn-warning" style="margin-right:30px"><span>Crear Articulo</span></button>
