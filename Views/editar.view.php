...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Edición de Artículos</b></span></h1>
		</div>
	</div>
						...
						<div class="comment-form-main">
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">
									...
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Título:</h2><input class="form-control" name="Titulo" placeholder="Titulo" type="text" value="<?php echo $articulo['Titulo']?>">
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Texto:</h2><textarea class="form-control" name="Texto" placeholder="Texto"><?php echo $articulo['Texto']?></textarea>
										</div>
									</div>						
									<div class="col-md-12" style="padding-top: 10px;">
										<h2>Imagen: <b><?php echo $articulo['ImgName']?></b></h2>
										<div class="col-lg-4 col-md-6 col-12 blog-item image-blog img-center" style="margin-bottom: 50px;">
											<img id="ImgA" src="Imagenes/<?php echo $articulo['ImgName']?>" class="img-fluid" style="height: 140px; width: 330px">
										</div>
										<div class="input-group mb-3">											
											...
											<div class="custom-file">
												<input id="Imagen" type="file" class="custom-file-input" name="Imagen" aria-describedby="inputGroupFileAddon01" accept="image/*">
												<label class="custom-file-label" id="imgname" for="Imagen">Selecciona el Archivo</label>
											</div>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Fecha:</h2><input class="form-control" name="Fecha" type="date" value="<?php echo $articulo['Fecha']?>" disabled>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Estado:    <?php echo $estado ?></h2><select class="custom-select" name="Estado"><option value="<?php echo $estado?>"><?php echo $estado?></option><option value="<?php echo $estado2?>"><?php echo $estado2?></option></select>
										</div>
									</div>
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Editar" class="btn btn-warning" style="margin-right:30px"><span>Editar Articulo</span></button>
										<a class="btn btn-secondary" href="escritor.php"><span>Volver</span></a>
									</div>
								</div>
							</form>
						</div>		
