...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Edición de Slider</b></span></h1>
		</div>
	</div>

	<div class="text-center text-white section lb" style="padding-top: 20px; padding-bottom: 20px">
		<a href="crear_slider.php" class="btn btn-primary">Añadir un nuevo Slider</a> 
	</div>
            ...
            <div class="row">
				<div class="col-lg-12 blog-post-single">
					<form method="POST">
						...
						<div class="text-center text-white post-btn" style="padding-top: 20px; padding-bottom: 20px">						
							<button name="Editar" class="hover-btn-new orange" type="submit"><span>Actualizar</span></button>						
						</div>
					</form>
				</div>
			</div>
