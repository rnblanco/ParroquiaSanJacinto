...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Edición del Evangelio</b></span></h1>
		</div>
	</div>
							...
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">									
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Título:</h2><input class="form-control" name="Titulo" placeholder="Titulo" type="text" value="<?php echo $eva['Titulo']?>">
										</div>
									</div>									
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Evangelio:</h2><textarea class="form-control" name="Evangelio" placeholder="Texto"><?php echo $eva['Evangelio']?></textarea>
										</div>
									</div>		
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Fecha:</h2><input class="form-control" type="date" value="<?php echo $eva['fecha_ini']?>" disabled>
										</div>
									</div>												
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Editar" class="btn btn-warning" style="margin-right:30px"><span>Editar Evangelio</span></button>
										<a class="btn btn-secondary" href="index.php"><span>Volver</span></a>
									</div>
								</div>
							</form>
						</div>		
