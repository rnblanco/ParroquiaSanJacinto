...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Creación de Evangelios</b></span></h1>
		</div>
	</div>
						...
						<div class="comment-form-main">
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">									
									...
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Evangelio:</h2><textarea class="form-control" name="Evangelio" placeholder="Texto"></textarea>
										</div>
									</div>
									<div class="col-md-12" style="padding-top: 10px;">
										<div class="form-group">
											<h2>Fecha:</h2><input class="form-control" name="Fecha" placeholder="Fecha" type="date">
										</div>
									</div>																																	
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Crear" class="btn btn-warning" style="margin-right:30px"><span>Crear Evangelio</span></button>
