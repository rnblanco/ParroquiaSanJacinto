...
<body class="host_version">
	...
	<div id="articulosbanner" class="all-title-box" style="background: url('Imagenes/articulos.jpg');">
		<div class="container text-center">
			<h1><span class="m_1" style="font-size:xx-large"><br><b>Añadir Nuevo Slider</b></span></h1>
		</div>
	</div>
							...
							<form method="POST" enctype="multipart/form-data">
								<div class="row" style="padding-top: 50px;">																								
									...
									<div class="col-md-12 post-btn text-center" style="padding: 25px 0px 30px 0px">
										<button type="submit" name="Crear" class="btn btn-warning" style="margin-right:30px"><span>Añadir Slider</span></button>
										<a class="btn btn-secondary" href="slider.php"><span>Volver</span></a>
									</div>
								</div>
							</form>
						</div>		
